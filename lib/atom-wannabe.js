...
class MarkRegistry {
  ...
  checkInvalids (tests) {
    ...
    Object
      ...
      .filter ((line) => !testLines || testLines.indexOf (this._invalidMarks.frame[line].data.test.line) === -1)
      .forEach ((line) => {
    ...
    Object
      ...
      .filter ((line) => !testLines || testLines.indexOf (this._invalidMarks.test[line].line) === -1)
      .forEach ((line) => {
